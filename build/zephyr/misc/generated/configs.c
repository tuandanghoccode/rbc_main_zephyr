...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 144000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RBC_MAINBOARD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RBC_MAINBOARD_STM32F407XX, 1);
